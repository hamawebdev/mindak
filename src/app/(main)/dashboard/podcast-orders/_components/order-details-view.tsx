    ...
    return (
      <div className="rounded-lg border border-destructive bg-destructive/10 p-6 text-destructive">
        ...
        <Button variant="outline" className="mt-4" asChild>
          <Link href="/dashboard/podcast-orders">Back to Podcast Reservations</Link>
        </Button>
      </div>
    );
  }
    ...
    <div className="@container/main space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Podcast Reservation Details</h1>
              ...
              {reservation.clientAnswers.map((answer, index) => (
                <div key={index}>
                  ...
                  <div>
                    ...
                    <p className="text-base">{answer.answerText || answer.value}</p>
                  </div>
                </div>
              ))}
            </CardContent>
                ...
                {statusHistory.map((item, index) => (
                  <div key={item.id} className="flex gap-3">
                    <div className="flex flex-col items-center">
                      ...
                      {index < statusHistory.length - 1 && <div className="w-px bg-border flex-1 my-1" />}
                    </div>
