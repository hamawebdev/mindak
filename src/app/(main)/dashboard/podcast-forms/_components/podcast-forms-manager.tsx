  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Podcast Form Questions</h1>
          <p className="text-muted-foreground">Manage questions and answers for the podcast booking form</p>
        </div>
    ...
    >
      ...
      <div className="flex-1 space-y-1">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          {hasAnswers && <span>• {question.answers.length} answer(s)</span>}
        </div>
      </div>
